...
async def cmd_start(message: Message, state: FSMContext, bot: Bot):
    ...
    "<i>Ваш надійний помічник у світі Mobile Legends: Bang Bang!</i>\n\n"
    "Цей бот створений для того, щоб зробити ваш ігровий досвід максимально зручним та цікавим. "
    "Від гайдів і білдів до організації турнірів — усе в одному місці! Давайте ознайомимося з основними можливостями бота:\n\n"
    "---\n\n"
    "🥷 <b>Персонажі</b>\n"
    "Пориньте у світ героїв Mobile Legends!\n"
    "• Досліджуйте класи героїв: маги, танки, стрільці, підтримка тощо.\n"
    "• Знаходьте улюблених героїв і вивчайте їх сильні та слабкі сторони.\n"
    "• Порівнюйте героїв, щоб обрати найкращого для свого стилю гри.\n"
    "• Отримуйте детальні гайди по кожному герою для ефективного використання їх здібностей.\n\n"
    "---\n\n"
    "⚜️ <b>Білди</b>\n"
    "Створюйте стратегії перемоги для своїх героїв:\n"
    "• Ознайомтеся з популярними білдами від найкращих гравців.\n"
    "• Створюйте власні білди, обираючи спорядження, емблеми та заклинання.\n"
    "• Зберігайте та редагуйте білди у будь-який час.\n\n"
    "---\n\n"
    "📚 <b>Гайди</b>\n"
    "Покращуйте свої навички та стратегії:\n"
    "• Читайте нові гайди з останніх оновлень.\n"
    "• Ознайомлюйтеся з популярними гайдами для досягнення успіху.\n"
    "• Знайдіть гайди для початківців або вивчіть просунуті техніки.\n"
    "• Дізнайтеся поради щодо командної гри.\n\n"
    "---\n\n"
    "🔄 <b>Контр-піки</b>\n"
    "Знаходьте найкращі рішення для перемоги над ворогами:\n"
    "• Шукайте контр-пік для будь-якого героя.\n"
    "• Переглядайте список контр-піків для популярних героїв.\n\n"
    "---\n\n"
    "📊 <b>Голосування</b>\n"
    "Станьте частиною спільноти:\n"
    "• Беріть участь у поточних опитуваннях.\n"
    "• Переглядайте свої голоси та результати.\n"
    "• Пропонуйте нові теми для опитувань.\n\n"
    "---\n\n"
    "🪪 <b>Профіль</b>\n"
    "Керуйте своїм обліковим записом:\n"
    "• Аналізуйте статистику, активність та рейтинг.\n"
    "• Відстежуйте свої досягнення та нагороди.\n"
    "• Налаштовуйте мову інтерфейсу, сповіщення та ігровий ID.\n\n"
    "---\n\n"
    "🏆 <b>Досягнення</b>\n"
    "Відзначайте свої успіхи:\n"
    "• Переглядайте зароблені бейджі та способи отримання нових.\n"
    "• Стежте за своїм прогресом у досягненні цілей.\n"
    "• Дивіться турнірну статистику та історію нагород.\n\n"
    "---\n\n"
    "⚙️ <b>Налаштування</b>\n"
    "Персоналізуйте ваш досвід:\n"
    "• Змініть мову інтерфейсу.\n"
    "• Оновіть username або ID гравця.\n"
    "• Керуйте сповіщеннями про новини, турніри та інші події.\n\n"
    "---\n\n"
    "❓ <b>Допомога</b>\n"
    "Отримуйте підтримку:\n"
    "• Інструкції щодо використання функцій бота.\n"
    "• Відповіді на найпоширеніші запитання.\n"
    "• Зв'язок із підтримкою для вирішення ваших запитів.\n\n"
    "---\n\n"
    "🎮 <b>Організація Турнірів</b>\n"
    "Проводьте змагання та отримуйте задоволення:\n"
    "• Класичні 5v5 турніри з логотипами та сітками.\n"
    "• Унікальні формати: 3v3, 2v2, 1v1 для різноманітності.\n"
    "• Квестові турніри з унікальними правилами та інтерактивними повідомленнями.\n\n"
    "---\n\n"
    "💡 <b>Mobile Legends Tournament Bot</b> — ваш ключ до успіху в грі!\n"
