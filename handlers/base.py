...
async def handle_main_menu_buttons(message: Message, state: FSMContext, db: AsyncSession, bot: Bot):
    ...
    # Відправка нового звичайного повідомлення з оновленою клавіатурою
...
# Інші обробники меню (наприклад, GPT Menu, Heroes Menu, тощо) залишаються без змін,
# але слід впевнитися, що вони редагують інлайн-повідомлення замість надсилання нових
# звичайних повідомлень з інформацією.
...
# Інші обробники меню та функції залишаються без змін.
# Переконайтесь, що в усіх обробниках ви редагуєте інлайн-повідомлення, а не надсилаєте нові звичайні.
...
# Обробники інших меню (наприклад, GPT Menu, Heroes Menu, тощо) повинні бути налаштовані аналогічно,
# тобто видаляти старі звичайні повідомлення, надсилати нові з оновленою клавіатурою та редагувати інлайн-повідомлення.
...
# Інші обробники меню повинні бути налаштовані аналогічно:
# - Видаляти старі звичайні повідомлення
# - Надсилати нові звичайні повідомлення з оновленою клавіатурою
# - Редагувати інлайн-повідомлення з відповідною інформацією
