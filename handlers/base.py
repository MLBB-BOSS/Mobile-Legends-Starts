...
async def cmd_start(message: Message, state: FSMContext, bot: Bot):
    ...
    interactive_message = await bot.send_message(
        chat_id=message.chat.id,
        text=(
    "🚀 <b>Ласкаво просимо до Mobile Legends: Starts</b> – вашого порталу до безмежних можливостей!\n\n"
    "Тут кожен гравець стає частиною великої спільноти, де підтримка та розвиток йдуть пліч-о-пліч.\n\n"
    "🌌 <b>Що чекає на вас?</b>\n\n"
    "🥷 <b>Герої</b>: глибокі аналізи та секрети використання кожного персонажа.\n\n"
    "📚 <b>Гайди</b>: ексклюзивні поради від топ-гравців.\n\n"
    "⚜️ <b>Білди</b>: створюйте ідеальні спорядження для вашого стилю гри.\n\n"
    "🏆 <b>Досягнення</b>: відстежуйте свій прогрес та святкуйте перемоги.\n\n"
    "💡 <b>Готові до неймовірних пригод?</b>\n\n"
    "Розпочніть свою подорож до вершини разом з Mobile Legends: Starts! 🏅"
        ),
