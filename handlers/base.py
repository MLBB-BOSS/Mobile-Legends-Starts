...
async def cmd_start(message: Message, state: FSMContext, bot: Bot):
    ...
    interactive_message = await bot.send_message(
        chat_id=message.chat.id,
        text=( "🌟 <b>Ласкаво просимо до Mobile Legends Starts!</b> 🌟\n\n"
"Твій незамінний помічник у світі Mobile Legends, де стратегія зустрічається з епічними битвами!\n\n"
"<i>“Успіх у грі – це не випадковість, а результат підготовки та знань.”</i>\n\n"
"---\n\n"
"✨ <b>Що вас чекає?</b>\n\n"
...
"---\n\n"
"🥷 <b>Персонажі</b>\n"
"Обирай героїв, порівнюй їх здібності та досягай перемог!\n\n"
"---\n\n"
"🚀 <b>Розпочни подорож вже зараз!</b>\n\n"
"Натисни «Розпочати» і поринь у світ Mobile Legends Starts.\n\n"
