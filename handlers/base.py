...
async def cmd_start(message: Message, state: FSMContext, bot: Bot):
    ...
    interactive_message = await bot.send_message(
        ...
        text=(
    "🧭 <b>Навігація</b>\n\n"
    "Оберіть розділ для подальших дій та відкрийте нові можливості:\n\n"
...
async def handle_navigation_menu_buttons(message: Message, state: FSMContext, bot: Bot):
    ...
    if user_choice == MenuButton.HEROES.value:
        new_text = (
            "🥷 **Персонажі**\n"
            "Пориньте у світ героїв Mobile Legends! У цьому розділі ви зможете:\n\n"
            "• Ознайомитися з класами героїв: маги, танки, стрільці, підтримка та інші.\n"
            "• Знайти конкретного героя за назвою та вивчити його сильні та слабкі сторони.\n"
            "• Порівняти героїв, щоб визначити, хто краще підходить для вашого стилю гри.\n"
            "• Отримати гайди по кожному герою для ефективного використання їх здібностей."
        )
        ...
        new_text = (
            "📚 **Гайди**\n"
            "Покращуйте свої навички за допомогою корисних матеріалів:\n\n"
            "• Нові гайди для ознайомлення з останніми оновленнями.\n"
            "• Популярні гайди, які допомагають гравцям досягати успіху.\n"
            "• Гайди для початківців та просунуті техніки для досвідчених гравців.\n"
            "• Поради щодо командної гри для досягнення найкращих результатів."
        )
        ...
        new_text = (
            "🔄 **Контр-піки**\n"
            "Знайдіть ефективних героїв проти ваших супротивників:\n\n"
            "• Пошук контр-піку для будь-якого героя.\n"
            "• Перегляд списку контр-піків для найпопулярніших героїв."
        )
        ...
        new_text = (
            "⚜️ **Білди**\n"
            "Створіть ідеальну стратегію для свого героя! У цьому розділі ви зможете:\n\n"
            "• Переглядати популярні білди, які використовують найкращі гравці.\n"
            "• Створювати власні білди, обираючи спорядження, емблеми та заклинання.\n"
            "• Зберігати та редагувати білди у будь-який час."
        )
        ...
        new_text = (
            "📊 **Голосування**\n"
            "Висловлюйте свою думку та дізнавайтеся погляди спільноти:\n\n"
            "• Участь у поточних опитуваннях.\n"
            "• Перегляд власних голосувань.\n"
            "• Пропозиція нових тем для опитувань."
        )
