...
# Пусте повідомлення з інлайн-кнопками
EMPTY_MESSAGE = "ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ"
...
async def cmd_search_hero(message: Message, state: FSMContext):
    ...
    # Можна додати окремий обробник для стану SEARCH_HERO
...
# Обробники для інших меню (Гайди, Контр-піки, Білди, Голосування, Профіль та ін.)

# Наприклад, обробник для меню Гайди
...
# Аналогічно, додайте обробники для інших пунктів меню...
