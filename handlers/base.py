...
async def cmd_start(message: Message, state: FSMContext, bot: Bot):
    ...
    main_message = await bot.send_message(
        ...
        text=(
            f"👋 Вітаємо, {user_name}, у Mobile Legends:Starts!\n\n"
    ...
    interactive_message = await bot.send_message(
        chat_id=message.chat.id,
        text=( "🌟 Ласкаво просимо до Mobile Legends Starts! 🌟\n\n"
...
async def handle_main_menu_buttons(message: Message, state: FSMContext, bot: Bot):
    ...
    if user_choice == MenuButton.NAVIGATION.value:
        ...
        new_interactive_text = "🧭 <b>Ти зараз у розділі «Навігація»</b>.\n\n"
"🔍 Тут зібрано все необхідне, щоб ти міг легко орієнтуватися:\n\n"
"🥷 <b>Персонажі:</b> Знайомся з героями, обирай найкращих і порівнюй їх здібності.\n"
"📘 <b>Гайди:</b> Отримуй доступ до стратегій і порад, які допоможуть перемагати в матчах.\n"
"⚙️ <b>Білди:</b> Створюй ідеальне спорядження для своїх героїв чи шукай готові рішення.\n"
"🔄 <b>Контр-піки:</b> Відкривай способи протидіяти героям суперника та залишайся у грі.\n"
"📊 <b>Голосування:</b> Долучайся до опитувань і впливай на розвиток спільноти Mobile Legends.\n\n"
"✨ Обирай, що тобі цікаво, і вперед до нових відкриттів! 👇"
