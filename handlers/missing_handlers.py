...
async def handle_teams(message: Message, state: FSMContext):
    bot = message.bot
...
@router.message(StateFilter(MenuStates.TEAMS_MENU))
async def handle_teams_menu_buttons(message: Message, state: FSMContext):
    bot = message.bot
    user_choice = message.text
...
@router.message(StateFilter(MenuStates.TRADING_MENU))
async def handle_trading_menu_buttons(message: Message, state: FSMContext):
    bot = message.bot
    user_choice = message.text
...
@router.message(StateFilter(MenuStates.SETTINGS_SUBMENU))
async def handle_settings_menu_buttons(message: Message, state: FSMContext):
    bot = message.bot
    user_choice = message.text
...
@router.message(StateFilter(MenuStates.SELECT_LANGUAGE))
async def handle_select_language(message: Message, state: FSMContext):
    bot = message.bot
...
@router.message(StateFilter(MenuStates.CHANGE_USERNAME))
...
@router.message(StateFilter(MenuStates.HELP_SUBMENU))
async def handle_help_menu_buttons(message: Message, state: FSMContext):
    bot = message.bot
    user_choice = message.text
...
async def handle_help_support(message: Message, state: FSMContext):
    bot = message.bot
...
async def handle_update_id(message: Message, state: FSMContext):
    bot = message.bot
...
async def handle_instructions(message: Message, state: FSMContext):
    bot = message.bot
...
async def handle_advanced_techniques(message: Message, state: FSMContext):
    bot = message.bot
...
async def handle_my_team(message: Message, state: FSMContext):
    bot = message.bot
...
@router.message(StateFilter(MenuStates.MY_TEAM_MENU))
async def handle_my_team_menu_buttons(message: Message, state: FSMContext):
    bot = message.bot
    user_choice = message.text
...
async def handle_my_profile_back(message: Message, state: FSMContext):
    bot = message.bot
