...
• 🛡️ <b>Танк:</b> Герої, які мають високий рівень захисту та можуть поглинати багато шкоди.
• ⚔️ <b>Бійці:</b> Збалансовані герої, здатні як атакувати, так і захищатися.
• 🏹 <b>Стрілеці:</b> Спеціалізуються на дальніх атаках та завданні великої шкоди з відстані.
• 🧙 <b>Маги:</b> Використовують магічні здібності для нанесення потужних атак та контролю ворогів.
...
• 🐣 <b>Гайди для початківців:</b> Основи гри та перші кроки для новачків.
• 🚀 <b>Просунуті техніки:</b> Складні стратегії та тактики для досвідчених гравців.
...
• ➕ <b>Створити новий білд:</b> Налаштуйте власний набір спорядження для вашого героя.
...
• 📅 <b>Поточні голосування:</b> Долучайтеся до активних опитувань.
• 🗂️ <b>Мої голосування:</b> Перегляньте свої попередні участі.
...
• 🏆 <b>Бейджі:</b> Перегляньте свої набрані бейджі за різні досягнення.
...
• 🎁 <b>Отримані нагороди:</b> Ознайомтеся з отриманими нагородами за видатні досягнення.
...
• ✏️ <b>Змінити Username:</b> Оновіть своє ім'я користувача.
• 🔄 <b>Оновити ID гравця:</b> Оновіть свій ігровий ID для коректної статистики.
...
CHANGE_USERNAME_TEXT = "✏️ Будь ласка, введіть новий <b>Username</b>:"
...
• 📝 <b>Надіслати відгук:</b> Поділися своїми враженнями та пропозиціями.
• 🐞 <b>Повідомити про помилку:</b> Опиши проблему, яку ти знайшов у боті.
...
CHANGE_USERNAME_RESPONSE_TEXT = """✏️ Ваш новий Username: <b>{new_username}</b> буде доданий після перевірки.
