...
M6_TEXT = "Середня інформація про M6"
...
EDIT_PROFILE_TEXT = "Редагування профілю: [інструкція або контент для редагування]"
...
META_MENU_TEXT = (
    "📈 <b>META Інформація</b>\n\n"
    "Дізнайтеся про найефективніших героїв у поточній META та отримайте рекомендації для покращення вашої гри."
)
...
# Додаткова константа, присутня тільки в об'єднаному файлі
BUST_TEXT = (
...
# ============================[METADATA AND TOOLS]=========================
# Змінні та константи, які не стосуються інтерфейсу, але потрібні для роботи.
