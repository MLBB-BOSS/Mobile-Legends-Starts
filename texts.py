...
🎮 Готовий до неймовірних пригод? Приєднуйся до нас та розкрий усі можливості для покращення своєї гри.
...
# Меню персонажів
HEROES_MENU_TEXT = """🥷 <b>Персонажі</b> 🛡️
...
# Меню контр-піків
COUNTER_PICKS_MENU_TEXT = """⚖️ <b>Контр-піки</b> 🕵️‍♂️
...
# Меню білдів
BUILDS_MENU_TEXT = """🛡️ <b>Білди</b> 🏗️

Оберіть опцію білдів:
"""

BUILDS_INTERACTIVE_TEXT = """🔧 <b>Опції білдів:</b> 🛠️
...
CREATE_BUILD_TEXT = """🏗️ <b>Створення білду:</b> 🛠️
...
# Меню голосування
VOTING_MENU_TEXT = """📊 <b>Голосування</b> 🗳️
...
# Меню досягнень
ACHIEVEMENTS_MENU_TEXT = """🏆 <b>Досягнення</b> 🎖️
...
SETTINGS_INTERACTIVE_TEXT = """🔧 <b>Опції налаштувань:</b> ⚙️
...
FEEDBACK_MENU_TEXT = """💌 <b>Зворотний Зв'язок</b> ✉️
...
HELP_SUPPORT_TEXT = """📞 <b>Підтримка:</b> 🛠️
