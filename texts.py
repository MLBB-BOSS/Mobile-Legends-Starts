...
• 🏆 <b>Організовувати турніри:</b> Створюй та управляй змаганнями для себе та друзів.
...
Оберіть опцію для роботи зі спорядженням:
"""
...
Оберіть категорію для перегляду своїх досягнень:
"""

ACHIEVEMENTS_INTERACTIVE_TEXT = """🎖️ <b>Категорії досягнень:</b>

• 🎖️ <b>Бейджі:</b> Подивіться всі ваші здобуті бейджі.
• 🚀 <b>Прогрес:</b> Відстежуйте свої досягнення та мету.
• 🏅 <b>Турнірна статистика:</b> Аналізуйте результати своїх змагань.
• 🎟️ <b>Нагороди:</b> Подивіться отримані винагороди за досягнення.

Оберіть категорію для продовження.
"""
...
• 📄 <b>Інструкції:</b> Дізнайтеся, як користуватися функціями бота.
...
GENERIC_ERROR_MESSAGE_TEXT = "⚠️ Сталася помилка. Спробуйте ще раз."

ERROR_MESSAGE_TEXT = "⚠️ Щось пішло не так. Зверніться до техпідтримки, якщо проблема не зникне."
...
CHANGE_USERNAME_RESPONSE_TEXT = """ℹ️ Ваш новий Username: <b>{new_username}</b> буде додано після перевірки.

Ця функція ще в розробці. Дякуємо за ваше терпіння!
"""

# Відповіді на інлайн кнопки
MLS_BUTTON_RESPONSE_TEXT = "🔹 Ви натиснули кнопку MLS. Функція ще не реалізована."
UNHANDLED_INLINE_BUTTON_TEXT = "⚠️ Ця кнопка поки що не обробляється. Скористайтеся іншими опціями меню."
