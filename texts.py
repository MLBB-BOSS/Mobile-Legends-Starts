...
🔮 <b>Функція M6:</b> Додатковий модуль для аналізу статистики та прогнозування результатів матчів.
...
🔮 <b>M6 Аналітика:</b> Використовуйте передові аналітичні інструменти для покращення своєї гри.
...
🔮 <b>M6 Аналітика:</b> Аналізуйте свої матчі та покращуйте свою гру за допомогою передових інструментів.
"""
...
• 🤖 <b>GPT Підтримка:</b> Отримуйте миттєві відповіді на ваші запитання.
• 🔮 <b>M6 Аналітика:</b> Використовуйте передові інструменти для аналізу вашої гри.
...
• 🔮 <b>M6 Аналітика:</b> Аналізуйте свої матчі та покращуйте свої навички.
...
• 🤖 <b>GPT Підтримка:</b> Отримуйте миттєві відповіді на запитання про героїв та їхні здібності.
• 🔮 <b>M6 Аналітика:</b> Дізнавайтеся, як різні герої впливають на ваші матчі за допомогою аналітики.
...
• 🧠 <b>GPT Підтримка:</b> Отримуйте докладні описи та стратегії використання героїв.
• 🔮 <b>M6 Аналітика:</b> Аналізуйте ефективність героїв у різних ситуаціях.
"""
...
• 🧠 <b>GPT Підтримка:</b> Отримуйте рекомендації щодо вибору гайдів відповідно до вашого стилю гри.
• 🔮 <b>M6 Аналітика:</b> Аналізуйте ефективність гайдів у покращенні вашої гри.
...
• 🔮 <b>M6 Аналітика:</b> Аналізуйте ефективність контр-піків у ваших матчах.
...
• 📄 <b>Обрані білди:</b> Перегляньте та керуйте своїми збереженими білдів.
...
• 🔮 <b>M6 Аналітика:</b> Аналізуйте ефективність білдів у різних ситуаціях гри.
...
• 🔮 <b>M6 Аналітика:</b> Аналізуйте результати голосувань для кращого розуміння трендів.
...
• 🔮 <b>M6 Аналітика:</b> Використовуйте передові інструменти для глибокого аналізу вашої гри.
...
• 🔮 <b>M6 Аналітика:</b> Аналізуйте свої досягнення та отримуйте рекомендації для їх покращення.
...
• 🔮 <b>M6 Аналітика:</b> Отримуйте детальний аналіз налаштувань для оптимізації вашого досвіду гри.
...
• 🧠 <b>GPT Підтримка:</b> Отримуйте миттєві відповіді на ваші запитання про функціонал бота.
• 🔮 <b>M6 Аналітика:</b> Аналізуйте ваші відгуки для покращення роботи бота.
...
• 🔮 <b>M6 Аналітика:</b> Аналізуйте отримані відповіді для кращого розуміння.
...
🔮 <b>M6 Аналітика:</b> Аналізуйте сильні та слабкі сторони героя для покращення вашої гри.
...
🧠 <b>GPT Підтримка:</b> Отримуйте поради щодо вибору унікального та ефективного Username.

🔮 <b>M6 Аналітика:</b> Аналізуйте ваш новий Username для покращення вашого профілю.
...
AI_INTRO_TEXT = (
    ...
    "🔮 <b>M6 Аналітика:</b> Використовуйте мої можливості для аналізу ваших ігрових показників та отримання корисних рекомендацій.\n\n"
