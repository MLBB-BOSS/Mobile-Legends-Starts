...
🎮 <b>Готовий розкрити весь потенціал своєї гри?</b>
Тут ти знайдеш гайди, стратегії, білди та багато іншого, що допоможе досягти нових висот у Mobile Legends: Bang Bang.

🚀 <b>Приєднуйся та починай свою пригоду прямо зараз!</b>

---
<b>Твоя гра. Твій стиль. Твій успіх. 💖</b>
"""
...
• 🧭 <b>Зручна навігація:</b> Швидкий доступ до гайдів, білдів і статистики.
• 🪪 <b>Мій профіль:</b> Налаштовуй і персоналізуй свій обліковий запис.
• 🥷 <b>Персонажі:</b> Відкрий для себе героїв, їхні здібності та ефективні стратегії.
• 📚 <b>Гайди:</b> Поради та інструкції для успіху в грі.
• 📊 <b>Статистика:</b> Аналізуй свій прогрес та ігрові досягнення.
• 🛡️ <b>Білди:</b> Обирай спорядження для перемог.
• 🏆 <b>Турніри:</b> Організовуй або долучайся до змагань.

---
Натисни кнопку <b>«Далі»</b>, щоб дізнатися більше.
"""
...
---
🚀 <b>Розпочни свою подорож!</b>

Натисни кнопку <b>«Розпочати»</b>, щоб перейти до основного меню.
"""

---
# Головне меню
MAIN_MENU_TEXT = """👋 Вітаємо, <b>{user_first_name}</b>!

Обери функцію нижче 👇
"""

MAIN_MENU_DESCRIPTION = """🎮 <b>Mobile Legends: Starts допоможе тобі:</b>

• 🏆 <b>Турніри:</b> Організовуй змагання або долучайся до них.
• 📸 <b>Скріншоти:</b> Зберігай та ділися моментами.
• 📊 <b>Активність:</b> Відстежуй свою і командну статистику.
• 🏅 <b>Досягнення:</b> Заробляй нагороди за успіхи.
"""

MAIN_MENU_ERROR_TEXT = "❗ Щось пішло не так. Натисніть <b>«Головне меню»</b>, щоб спробувати ще раз."

---
# Меню профілю
PROFILE_MENU_TEXT = """🪪 <b>Мій профіль</b>

Переглянь свої дані або зміни налаштування 👇
"""
...
HEROES_INTERACTIVE_TEXT = """📂 <b>Категорії:</b>

• 🛡️ <b>Танк:</b> Герої для захисту команди.
• 🧙‍♂️ <b>Маг:</b> Потужні магічні атаки.
• 🏹 <b>Стрілець:</b> Велика шкода на відстані.
• ⚔️ <b>Асасін:</b> Швидке знищення ворогів.
• ❤️ <b>Підтримка:</b> Лікування і бафи.
• 🗡️ <b>Боєць:</b> Збалансована атака і захист.
"""
...
GUIDES_INTERACTIVE_TEXT = """📖 <b>Підрозділи:</b>

• 🆕 <b>Нові:</b> Свіжі оновлення.
• 🌟 <b>Топ:</b> Найкращі поради.
• 📘 <b>Для початківців:</b> Основи гри.
• 🧙 <b>Стратегії:</b> Складні техніки.
• 🤝 <b>Командна гра:</b> Тактики для команди.
"""
...
Список топ гайдів скоро буде доступний. Слідкуйте за оновленнями!
"""
...
ADVANCED_TECHNIQUES_TEXT = """🧙 <b>Стратегії:</b>
...
ERROR_MESSAGE_TEXT = "❗ Щось пішло не так. Натисніть <b>«Головне меню»</b> для перезапуску."
USE_BUTTON_NAVIGATION_TEXT = "🔘 Будь ласка, скористайтесь кнопками нижче."
