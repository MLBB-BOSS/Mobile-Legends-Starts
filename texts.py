...
WELCOME_NEW_USER_TEXT = """🔥 <b>Ласкаво просимо до Mobile Legends: Starts</b> – твоєї нової арени для героїчних звершень! 🔥

🎮 Тут ти створиш свою легенду, відкриєш нові можливості, опануєш найкращі тактики та досягнеш вершин у світі <b>Mobile Legends</b>.

✨ <b>Що робить Mobile Legends: Starts особливим?</b>

🥷 <b>Герої:</b> Відкривай секрети кожного персонажа, їхні сильні сторони та ефективні контр-піки.
📚 <b>Гайди:</b> Отримуй ексклюзивні поради, покрокові інструкції та стратегії, які допоможуть тобі вигравати кожен матч.
⚜️ <b>Білди:</b> Створюй ідеальні набори спорядження для своїх героїв або обирай з готових варіантів.
🏆 <b>Досягнення:</b> Відстежуй свій прогрес, здобувай нагороди та підкорюй нові вершини.

🔮 <b>Для кого це?</b> Для гравців, які прагнуть не просто грати, а домінувати, перемагати та залишатися на піку майстерності.

💪 <b>Mobile Legends: Starts</b> – твій перший крок до легендарних перемог!
...
Натисни кнопку <b>«Розпочати»</b>, щоб перейти до основного меню та скористатися всіма можливостями бота.
...
MAIN_MENU_DESCRIPTION = """🎮 <b>Цей бот допоможе тобі:</b>
...
• ⚔️ <b>Бійці:</b> Збалансовані герої, здатні атакувати та захищатися.
• 🏹 <b>Стрілеці:</b> Спеціалізуються на дальніх атаках та завданні великої шкоди.
• 🧙 <b>Маги:</b> Використовують магічні здібності для потужних атак та контролю ворогів.
...
# Меню контр-піків
COUNTER_PICKS_MENU_TEXT = """🔄 <b>Контр-піки</b>
