...
WELCOME_NEW_USER_TEXT = """🔥 <b>Ласкаво просимо до Mobile Legends: Starts</b> – твого нового епічного союзника у світі <b>Mobile Legends</b>! 🔥

🎮 Тут ти створиш свою легенду, відкриєш нові можливості, опануєш найкращі тактики та досягнеш вершин у грі.
...
• 🗡️ <b>Асасіни:</b> Герої, що спеціалізуються на швидких атаках та високій мобільності, здатні швидко нейтралізувати ворогів.
